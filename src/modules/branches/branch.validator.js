...
module.exports = {
  add: (httpRequest) => {
    ...
    address: Joi.string().messages({'string.base': 'address must be a string', 'any.required': 'address is required'}).allow(null, ''),
    email: Joi.string().messages({'string.base': 'email must be a string', 'any.required': 'email is required'}).allow(null, ''),
    contact: Joi.string().messages({'string.base': 'contact must be a string', 'any.required': 'contact is required'}).allow(null, ''),
